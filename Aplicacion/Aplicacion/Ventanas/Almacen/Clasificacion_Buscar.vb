Public Class Clasificacion_Buscar
    ...
    Private Sub ConfiguraCampos()
        _campos.Add("clasificacion_Descripcion")
        _tipocampo.Add("String")
        _titulocampo.Add("Descripcion")

    End Sub

    Private Sub Clasificacion_Buscar_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        'busca el formulario padre de divisas para cambiar el gridview
        Dim _form_clasificacion_catalogo As Clasificacion_Catalogo = My.Application.OpenForms("Clasificacion_Catalogo")
        _form_clasificacion_catalogo.dgv_clasificacion.Rows.Clear()
        _form_clasificacion_catalogo.LoadDataGridInfo()

    End Sub

    Private Sub Clasificacion_Buscar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Carga los campos
        ConfiguraCampos()
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        If Not errores Then
            ...
            dtsresult = _form_clasificacion_catalogo.AlmacenCls.SelClasificacion(campos, consulta)
            ...
            For Each dr As DataRow In dtsresult.Tables(0).Rows
                ...
                _form_clasificacion_catalogo.dgv_clasificacion.Rows.Add(row)
            Next
        End If
    End Sub
End Class